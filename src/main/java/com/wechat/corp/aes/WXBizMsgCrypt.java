...
public class WXBizMsgCrypt {
	private transient static final Logger logger = LoggerFactory.getLogger(WXBizMsgCrypt.class);
	...
	public String DecryptMsg(String msgSignature, String timeStamp, String nonce, String postData)
		...
		logger.info("接收到的消息密文: {}" , encrypt[1].toString());
		// 解密
